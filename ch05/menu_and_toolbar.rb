...
class MenuAndToolbarExample
  ...
  def initialize
    ...
    puts "Started creating menu and toolbars"
    create_menu
    create_toolbar
  ...
  def create_toolbar
    ...
    20.times do
      ...
      icon = Swt::Graphics::Image.new(@shell.display, "C:/workspace/JRuby_Cookbook/ch05/alarm-clock--plus.png")
...
Swt::Widgets::Display.set_app_name "Menus and Toolbars Example"
 
app = MenuAndToolbarExample.new
app.start
